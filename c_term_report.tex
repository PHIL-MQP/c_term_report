...
\section{Experimental Results} \label{experiments}
  ...
  \subsection{Comparing Our IMU Localization to the NavX API}
    ...
    We applied pure double integration of raw IMU data on the ``Nypro Circles'' test (described in Section \ref{section:drift_bias}) to get locations of the robot. We determined that it was not sufficient to meet our accuracy standard. Moreover, NavX location API (Figure \ref{fig:displacement_comparison}) also didn't meet our standard.
