...
\section{Experimental Results} \label{experiments}
  ...
  \subsection{Localizing with IMU and Encoder on the Turtlebot}
    ...
    % not sure this should actually be a section...
  ...
  \subsection{Detecting ArUco Tags at a Distance}
     % This test _must_ be redone or removed entirely.
  ...
  \subsection{How Far Apart Should Tags be Placed?} \label{section:tag_placement}
    ...
    If we now consider only valid position estimates, and not just any detected tag, ... % FIXME: add kacper's analysis which is subtly different
